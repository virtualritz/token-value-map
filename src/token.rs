...
///
/// Archives as [`ArchivedString`](rkyv::string::ArchivedString) via manual
/// [`Archive`](rkyv::Archive) impl, so `rkyv` support works regardless of
/// whether the `ustr` backend provides its own rkyv support.
